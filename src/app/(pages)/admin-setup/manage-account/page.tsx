...
export default function ManageYourAccount() {
	return (
		<section className="max-w-full text-foundation-black-black-400 flex flex-col items-start justify-start leading-[normal] tracking-[normal] [row-gap:5px] xl:flex-wrap container 2md:px-12 px-4 ">
