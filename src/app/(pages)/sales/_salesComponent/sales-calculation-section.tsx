...
export default function SalesCalculationSection() {
  return (
		<div className="w-full !m-[0] absolute top-[0px] left-[0px] flex flex-row items-start justify-start gap-[27px] max-w-full lg:flex-wrap">
			<div className="flex-[0.8929] shadow-[0px_2px_10px_rgba(0,_0,_0,_0.1)] rounded-2xl bg-white flex flex-col items-start justify-start pt-[18px] px-[27px] pb-[4.6px] box-border gap-[12px] min-w-[209px] sm:flex-1">
				...
				<div className="flex flex-col items-start justify-start gap-[5.8px] text-5xl text-foundation-grey-grey-800">
					<div className="relative shrink-0 whitespace-nowrap z-[1] sm:text-lgi">
						$ 50,000,000
					</div>
