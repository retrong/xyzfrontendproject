            ...
            <div className='flex flex-col items-center justify-start'>
                <div className="flex flex-col items-center justify-center gap-[16px]">
                    <div className=" text-foundation-black-black-400 text-center">
                        ...
                        <h4 className="max-w-[1039px] text-foundation-grey-grey-900 text-base font-normal text-center w-full">
                            ...
                            our customizable solutions cater to your specific needs.
                        </h4>
                    </div>
                </div>
                <div className="flex flex-row flex-wrap justify-start mq750:justify-center items-start gap-[32px] text-[26px] mt-10">
                    {featureCard.map((feature) => (
                        <div key={feature.title} className="w-[368px] rounded-lg relative bg-foundation-grey-grey-50 hover:bg-foundation-purple-purple-400 hover:text-foundation-grey-grey-300 h-[535px] flex flex-col items-center justify-center p-6 box-border text-center cursor-pointer">
                            <Image src={feature.image} alt="" className='w-fit h-[200px] object-contain ' />
